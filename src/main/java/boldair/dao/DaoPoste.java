...
public interface DaoPoste extends CrudRepository<Poste, Long>, PagingAndSortingRepository<Poste, Long> {
	
	Page<Poste> findByNomContainingIgnoreCase( String search, Pageable pageable );
